...
const SaleDeclaracionMedioPago = ({ sale }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const opt = {
      margin: 0,
      filename: `DeclaracionJuradaMedioDePago-${sale.id}.pdf`,
    ...
    <>
      <td>
        <button type="button" onClick={handleDownloadPDF}>
          Descargar Carta Poder Declaracion Jurada Medio De Pago (PDF)
        </button>
        ...
        >
          <DeclaracionJuradaMedioDePago ref={cartaRef} sale={sale} />
        </div>
        {showPreview && (
          <div style={{
            position: 'fixed',
...
SaleDeclaracionMedioPago.propTypes = {
...
export default SaleDeclaracionMedioPago;
